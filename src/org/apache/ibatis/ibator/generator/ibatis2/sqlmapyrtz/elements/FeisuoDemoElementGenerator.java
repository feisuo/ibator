 ...
 *
 */
public class FeisuoDemoElementGenerator extends AbstractXmlElementGenerator {
    
    public FeisuoDemoElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", XmlConstantsYrtz.INSERT_STATEMENT_ID)); //$NON-NLS-1$
