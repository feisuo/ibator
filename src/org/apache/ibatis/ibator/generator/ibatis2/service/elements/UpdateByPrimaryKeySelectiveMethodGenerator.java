...
public class UpdateByPrimaryKeySelectiveMethodGenerator extends
        AbstractServiceElementGenerator {
    ...
    public void addImplementationElements(TopLevelClass topLevelClass) {
        ...
        sb.append(serviceTemplate.getUpdateMethod(JavaBeansUtil.getPropertyName(dao.getShortName()),
        		getServiceMethodNameCalculator().getUpdateByPrimaryKeySelectiveMethodName(introspectedTable),
                "record")); //$NON-NLS-1$
    ...
    private Method getMethodShell(Set<FullyQualifiedJavaType> importedTypes) {
        ...
        method.setName(getServiceMethodNameCalculator().getUpdateByPrimaryKeySelectiveMethodName(introspectedTable));
