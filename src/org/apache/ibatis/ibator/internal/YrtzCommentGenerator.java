 ...
 * @author liudh
 */
public class YrtzCommentGenerator implements CommentGenerator {
    
    private Properties properties;
    private boolean suppressDate;

    public YrtzCommentGenerator() {
        super();
    ...
    public void addFieldComment(Field field, FullyQualifiedTable table) {
        ...
        field.addJavaDocLine("/**"); //$NON-NLS-1$
//        field.addJavaDocLine(" * This field was generated by yrtz."); //$NON-NLS-1$
    ...
    public void addClassComment(InnerClass innerClass, FullyQualifiedTable table) {
        ...
        innerClass.addJavaDocLine(" * This class was generated by yrtz."); //$NON-NLS-1$
    ...
    public void addEnumComment(InnerEnum innerEnum, FullyQualifiedTable table) {
        ...
        innerEnum.addJavaDocLine(" * This enum was generated by yrtz."); //$NON-NLS-1$
    ...
    public void addGetterComment(Method method, FullyQualifiedTable table, String columnName) {
        ...
        method.addJavaDocLine(" * This method was generated by yrtz."); //$NON-NLS-1$
    
        sb.append(" * 返回数据库列 "); //$NON-NLS-1$
        sb.append(table);
        sb.append('.');
        sb.append(columnName);
        sb.append(" 的值");
...
//        compilationUnit.addFileCommentLine(" *@author feisuo");
//        compilationUnit.addFileCommentLine(" */");
    }
    ...
    public void addComment(XmlElement xmlElement) {
        ...
        xmlElement.addElement(new TextElement(
                "  WARNING - 该元素由yrtz自动生成, do not modify.")); //$NON-NLS-1$
